        ...
        child: Column(
          ...
          children: [
            ...
            if (controller.image != null && controller.image!.isNotEmpty)
              ClipRRect(
                ...
                child: Image.network(
                  ...
                  height: 260,
                  fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(height: 260, color: Colors.grey[300]),
                ),
              )
            else
              Container(
            ...
            Padding(
              ...
              child: Text(
                controller.description ?? "No summary available",
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  if (controller.link != null && Uri.tryParse(controller.link!) != null) {
                    await launchUrl(Uri.parse(controller.link!),
            ...
            Obx(() {
              if (controller.similarArticles.isEmpty) {
                return const Padding(
                  ...
                  child: Text("No similar news found"),
                );
              }
