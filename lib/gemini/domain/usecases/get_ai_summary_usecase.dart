import 'package:news_depi_final_project/Models/News_Models/GnewsModel.dart';
import 'package:news_depi_final_project/gemini/domain/repositories/i_gemini_repository.dart';
...
class GetAiSummaryUseCase {
  ...
  // ============================================================
  // 1. Search Summary (English Only)
  // ============================================================
  Future<String> call({
    required String topic,
    required List<Article> articles,
  }) async {
    // 1. Prepare content (Fixed the source name error)
...
''';
  ...
  // ============================================================
  // 2. AI Briefing (Dual Language - Optional, kept just in case)
  // ============================================================
